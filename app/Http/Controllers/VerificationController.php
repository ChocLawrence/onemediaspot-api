...
class VerificationController extends Controller
{
    ...
    public function addVerification(Request $request)
    {
        try{
            ...
            $verification->institution_id = $request->institution_id;
            $verification->ext_institution_id = $request->ext_institution_id;
            $verification->asset_type_id = $request->asset_type_id;
    ...
    public function changeVerificationStatus(Request $request, $id)
    {
        ...
        try{
            ...
            $validator = $this->validateVerificationStatus();
            if($validator->fails()){
               return $this->errorResponse($validator->messages(), 422);
            }
    ...
    public function validateVerification(){
        return Validator::make(request()->all(), [
            ...
            'ext_institution_id' => 'nullable|exists:institutions,id',
    ...
    public function validateVerificationStatus(){
        return Validator::make(request()->all(), [
            'status_id' => 'nullable|exists:statuses,id',
        ]);
    }
